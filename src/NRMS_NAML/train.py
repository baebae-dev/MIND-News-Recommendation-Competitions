...
# File: src/NRMS_NAML/train.py
# - This file trains a model on datasets.
#
# Version: 1.0
#######################################################################################################
...
from NRMS_NAML.utils.dataloader import DataSetTrn, DataSetTest
from NRMS_NAML.utils.evaluation import ndcg_score, mrr_score
from NRMS_NAML.utils.selector import NewsSelector
...
def main(data_path, data, out_path, config_path):
    ...
    if model_path is not None:  # load a model if the path is given
